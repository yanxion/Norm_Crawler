# -*- coding: utf-8 -*-
"""
    Base crawler template, for general news, fast formation.
"""
...
# CONTENT TIME
        # settings around time.
        self.CONTENT_TIME_CSS = ''
        ...
        self.CONTENT_TIME_FORMAT = u'%Y-%m'.encode('utf-8')

# CONTENT TEXT
        # settings around content.
        self.CONTENT_TEXT_CSS = ''
        self.CONTENT_TEXT_REMOVE_CSS = 'script'
