...
# POST
    ...
    # post author
        self.POST_AUTHOR_CSS = '.authorName'
    ...
    # post time
        self.POST_TIME_CSS = '.postDateLine'
        self.POST_TIME_ATTR = ''
        self.POST_TIME_REMOVE_CSS = 'script'
        self.POST_TIME_REPLACE_RE = ['[^0-9-\s:]']
        self.POST_TIME_REPLACE_STRING = ['']
        self.POST_TIME_FORMAT = u'%Y-%m-%d %H:%M'.encode('utf-8')
        # %Y: year in n digits
...
# COMMENT
        # comment setting
        self.COMMENT_EQ_DOCUMENT = '.plhin'
    # comment author
        self.COMMENT_AUTHOR_CSS = '.authorName'
    ...
    # comment floor
        self.COMMENT_FLOOR_CSS = '.btncopy a em'
    ...
    # comment time
        self.COMMENT_TIME_CSS = '.postDateLine'
        self.COMMENT_TIME_ATTR = ''
        self.COMMENT_TIME_REMOVE_CSS = 'script'
        self.COMMENT_TIME_REPLACE_RE = ['[^0-9-\s:]']
        self.COMMENT_TIME_REPLACE_STRING = ['']
        self.COMMENT_TIME_FORMAT = u'%Y-%m-%d %H:%M'.encode('utf-8')
        # %Y: year in n digits
        # %y: year in 2 digits, [00, 99]
        # %m: month, [01, 12]
        # %d: day, [01,31]
...
if __name__ == '__main__':
    ...
    test_set = {
        ...
        'item': {  # for normal item parse
            'url': 'https://ck101.com/thread-2718663-1-1.html',
