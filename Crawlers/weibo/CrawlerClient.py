...
class CrawlerClient(Crawler):
    def __init__(self, **kwargs):
        ...
        self.m_cookies = self.m_util.get_cookies('00886974403106', 'Abcd1234!')
        # self.m_cookies = {
        ...
        self.w_cookies = self.w_util.get_cookies('00886974403106', 'Abcd1234!')
        # self.w_cookies = {
    ...
    def get_w_user_post(self, uid, bid, source, id):
        ...
        for i in range(res('script').length):
            if res('script').eq(i).text().find('"domid":"Pl_Official_WeiboDetail__') >= 0:
    ...
    def get_w_userinfo(self, oid):
        ...
        profile_jdata = '{}'
        for i in range(res('script').length):
            if res('script').eq(i).text().find('"domid":"Pl_Official_PersonalInfo__') >= 0:
        ...
        for i in range(res('div.PCD_text_b2').length):
            ...
            if title == u'工作信息':
                ...
                self.user_info['educationinfo'] = res('div.PCD_text_b2').eq(i).find('ul.clearfix span.pt_detail').text()
